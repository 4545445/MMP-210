...
function jsonLoaded(penguins){
   ...
   //challenge 1 show emperor penguin
    ...
    //looop through cormorants and show them
    for(var i=0;i<cormorants.length; i++){
        text(cormorants[i],20,20*i+50); //this places them each 20 pixesl apart with a 50px offset from the top of the screen.
    }//end for
